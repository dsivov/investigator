...
def build_graph(entity_groups, working_state, representatives=None):
    tangos_log.info("Building coarse-grained graph from chunk affiliations...")
...
def score_graph_by_connectivity(tangraph, edges_enrichment_results, merged_entities, root=None,
    ...
    * Orphan edges (an endpoint dropped) are removed; any survivor left
    ...
    """
    undirected = tangraph.to_undirected()
