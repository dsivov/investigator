...
top (``tangraph_host``, ``tangraph_port``, ``analytic_engine_enabled``, ...).
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--tangraph_host",
        default=get_env_value("TANGRAPH_HOST", "0.0.0.0"),
        help="Server tangraph host (default: from env or 0.0.0.0)",
    )
    parser.add_argument(
        "--tangraph_port",
        type=int,
        default=get_env_value("TANGRAPH_PORT", 5003, int),
        help="Server tangraph port (default: from env or 5003)",
    )
    parser.add_argument(
        "--reranker_host",
