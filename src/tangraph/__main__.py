"""Command-line entry point: ``python -m tangraph``.
...
from tangraph.config import SecretLoader, global_args
...
from tangraph.app import create_app  # noqa: E402

_log = logging.getLogger("tangraph")
...
def main() -> None:
    ...
    if global_args.analytic_engine_enabled:
        from tangraph.analytics.reranker import main as rag_rerank_server
        from tangraph.analytics.server import main as lightrag_server
    ...
    app.run(host=global_args.tangraph_host, port=global_args.tangraph_port)
