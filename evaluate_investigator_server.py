...
Usage:
    PYTHONPATH=.:src /home/dsivov/.conda/envs/tangos/bin/python \\
      evaluate_investigator_server.py --query "Wagner Group Russia" --max-articles 15 --period 30d
...
INVESTIGATOR_TMFG=1 set (so Phase 1-3 network analysis is included).
"""
...
def main():
    ...
    if network:
        ...
        print("      network analysis: (none -- is INVESTIGATOR_TMFG=1 set on the server?)")
